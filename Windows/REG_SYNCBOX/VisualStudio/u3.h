...
long getCalibrationInfo(LJ_HANDLE hDevice,
...
long getTdacCalibrationInfo(LJ_HANDLE hDevice,
...
long eTCConfig(LJ_HANDLE Handle,
                long *aEnableTimers,
...
long eTCValues(LJ_HANDLE Handle,
                long *aReadTimers,
...
long ehConfigIO(LJ_HANDLE hDevice,
                 uint8 inWriteMask,
...
long ehConfigTimerClock(LJ_HANDLE hDevice,
...
long ehFeedback(LJ_HANDLE hDevice,
